...
9. Testable Computational Program
  ...
  Output: optimal label lambda^, approximant T^, residual R.
  ...
  Input: label lambda^*, residual coefficient sequence c res.
  ...
  regression of log|RL| against ell(lambda^*L); the slope times -1/log$\varphi$-1 is muT.
