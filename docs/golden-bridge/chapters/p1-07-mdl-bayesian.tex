...
7. MDL and Bayesian Evidence Framework
  ...
  framework \citep{barron1998,grunwald2007} provides the primary
  ...
  Standard calibration of log10 B \citep{grunwald2007}:
  ...
  Following Barron, Rissanen \& Yu \citep{barron1998} and Grünwald \citep{grunwald2007}, the total description
  ...
  complexity bound C, and the selected expression F\textasciicircum{}*(theta). The code length is
  ...
  non-Euclidean statistical manifold over R\textasciicircum{}+, with geodesic distances governed by the
  ...
  sense of Chaitin \citep{chaitin1987}. The MDL quantity DeltaMDL provides a computable lower
