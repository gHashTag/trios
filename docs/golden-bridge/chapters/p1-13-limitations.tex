...
13. Limitations and Scope of Validity
  ...
  over-complete dictionaries and implies that the best-fit expression F^*(X) is not
  uniquely defined near dense regions of the grammar lattice.

  13.6 Asymptotic Saturation
  As C $\rightarrow$ $\in$fty, S(C) becomes dense in R^+ and coverage trivially approaches 1 for any $\varepsilon
