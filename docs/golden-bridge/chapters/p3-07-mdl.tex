...
7. MDL Interpretation of Representation Quality
  ...
  - Model: Trinity monomial T\textasciicircum{} = PiL(x), requiring ell(lambda\textasciicircum{}) bits (Definition 2.6);
  ...
  MDL(T\textasciicircum{}, c res) = ell(lambda\textasciicircum{}) + sumk=0D ell(ck res),
  ...
  Proof sketch. Among all T $\in$ T with ell(lambdaT) $\leq$ L, the choice T\textasciicircum{}* = PiL(x) minimises
  ...
  K(x|$\varepsilon$) $\leq$ MDL(T\textasciicircum{}*, c res) + O(log K(x|$\varepsilon$)),
