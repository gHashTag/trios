...
12. Conclusion
  ...
  - The GOLDEN BRIDGE (Trinity-Pellis Bridge) unification representation (T\textasciicircum{}*, c res);
  ...
  - The symbolic phase transition conjecture characterising the critical exponent mu\textasciicircum{}* =
  1;
