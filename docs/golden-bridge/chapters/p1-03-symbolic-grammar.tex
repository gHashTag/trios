...
3. Symbolic Grammar and Complexity Metric
  ...
  code length \citep{barron1998,chaitin1987}.
  ...
  Under the logarithmic map log : R\textasciicircum{}+ $\rightarrow$ R, expression (1) becomes
  ...
  The grammar G$\varphi$ induces a non-uniform prior measure over R\textasciicircum{}+. The empirical
  counting measure
  ...
  elements and is generically non-uniform over R\textasciicircum{}+. The non-uniformity of Psigma must
  ...
  Given a target constant X $\in$ R\textasciicircum{}+, the approximation quality at complexity C is
  ...
  sufficiently large C whenever X $\in$ R\textasciicircum{}+. The statistical question concerns the rate of
