...
9. Pellis Hierarchical Expansion
  ...
  cannot represent values near lattice points without increasing C indefinitely. The Pellis \citep{pellis2021alpha}
  ...
  A hierarchical representation of a target quantity X $\in$ R\textasciicircum{}+ at depth K is defined as

  X approx F(K)($\varphi$) = sumk=1K ck $\varphi$-k, ck $\in$ Z, K $\in$ N. 34

  The formal asymptotic extension is

  F($\varphi$) $\sim$ sumk=1\textasciicircum{}$\in$fty ck $\varphi$-k as k $\rightarrow$ $\in$fty, 35
