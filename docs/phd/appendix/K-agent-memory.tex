...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/K-agent-memory.tex}\par\smallskip
...
\texttt{docs/phd/chapters/K-agent-memory.tex} will be regenerated automatically
