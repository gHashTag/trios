...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-L-pollen-channel.png}}
\caption{Azbuka triptych: Deferred chapter: Pollen Channel (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth,keepaspectratio]{ch16-360-lane-grid.png}
\caption*{Figure --- Pollen channel <-> Railway PostgreSQL flow --- interim placeholder render.}
\end{figure}
