...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{L-pollen-channel.jpg}
  \caption{Pollen channel: how agents broadcast partial results across the apiary.}
  \label{fig:hero-app-l}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{W8-AL-pollen-channel-capacity.png}
  \caption{THE SOURCE / THE NOISE / THE CAPACITY. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave8-W8-AL-pollen-channel-capacity}
\end{figure}
