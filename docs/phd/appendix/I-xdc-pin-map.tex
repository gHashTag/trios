...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-I-xdc-pin-map.png}}
\caption{Azbuka triptych: Appendix I: XDC Pin Map — QMTech XC7A100T/200T (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
