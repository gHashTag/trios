...
\texttt{gHashTag/trios} monorepo, distributed across three roots:
...
\textbf{Total: 57 \texttt{*.v} files, 427 top-level theorems, 97.1\,\%
\texttt{Qed}-closed} (see Appendix~\ref{app:F} for the full inventory).
