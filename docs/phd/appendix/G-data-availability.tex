...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{X-03-manifest-hash-freeze.png}
  \caption{Appendix Plate X-03: Manifest, hash, freeze. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave7-X-03-manifest-hash-freeze}
\end{figure}
% --- end Wave-7 plates ---
