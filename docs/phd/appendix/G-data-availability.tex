...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-G-data-availability.png}}
\caption{Azbuka triptych: Data Availability (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
