...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-H-acm-ae-checklist.png}}
\caption{Azbuka triptych: ACM Artifact Evaluation Checklist (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
