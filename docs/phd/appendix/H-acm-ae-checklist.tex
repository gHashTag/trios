...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{H-acm-ae-checklist.jpg}
  \caption{ACM Artifact Evaluation packet: reviewer-facing checklist of badges, datasets, and reproduction scripts.}
  \label{fig:hero-app-h}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{X-04-acm-badge-pack.png}
  \caption{Appendix Plate X-04: ACM badge pack. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave7-X-04-acm-badge-pack}
\end{figure}
% --- end Wave-7 plates ---
