...
\texttt{trinity-fpga/bitstream/design.bit.sha256}.}
\end{table}
...
\texttt{gHashTag/trinity-fpga} (Apache~2.0). To reproduce:

\begin{enumerate}
  \item Flash ESP32 with \texttt{firmware/xvc-esp32/xvc-esp32.ino}
