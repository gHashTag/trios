...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=0.85\linewidth,keepaspectratio]{16-sacred-ratios.png}}
\caption{Visual key to the sacred ratios used throughout this monograph — $\varphi$, $\varphi^{2}$, $\varphi^{-1}$, $\varphi^{-2}$ — rendered in engraved-triptych form for quick reference.}
\end{figure}
...
\(\mathrm{INV}\text{-}k\)
  & The \(k\)-th IGLA runtime invariant, \(k=1,\ldots,5\);
    mechanized in \filepath{trinity-clara/proofs/igla/}.
