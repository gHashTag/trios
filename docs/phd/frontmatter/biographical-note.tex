...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=0.55\linewidth,keepaspectratio]{author-vasilev-portrait.jpg}}
\caption{Dmitrii Vasilev (Дмитрий Васильев), author. The lapel pin renders the Trinity emblem $\varphi^{2}+\varphi^{-2}=3$ at the T27 Coptic-agent grade.}
\end{figure}
