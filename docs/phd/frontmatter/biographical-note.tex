...
%           submitting candidate: Дмитрий Васильев / Dmitrii Vasilev,
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=0.85\linewidth,keepaspectratio]{33-epilogue.png}}
\caption{Epilogue figure standing in for the biographical sketch — the author's intellectual journey traced from origin to closure in the engraved tradition.}
\end{figure}
...
\textbf{Dmitrii Vasilev} (\textbf{Дмитрий Васильев}) is a doctoral candidate
