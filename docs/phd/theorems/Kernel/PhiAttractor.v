...
(* ================================================================
   ...
   The full proof now lives at:
     ...
     gHashTag/t27/proofs/canonical/kernel/PhiAttractor.v
       (logical path: Trinity.Canonical.Kernel.PhiAttractor)
...
From Trinity.Canonical.Kernel Require Export PhiAttractor.
