...
% Original file moved to docs/phd/quarantine/ch\_06.tex (LaTeX parse error).
...
\section*{Deferred chapter: 06}
\addcontentsline{toc}{section}{Deferred chapter: 06}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_06.tex}\par\smallskip
...
The repository draft of \textsc{06} contained a LaTeX parse error
...
Chapter \textsc{06} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_06.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{06}.
