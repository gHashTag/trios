...
% Original file moved to docs/phd/quarantine/ch\_05.tex (LaTeX parse error).
...
\section*{Deferred chapter: 05}
\addcontentsline{toc}{section}{Deferred chapter: 05}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_05.tex}\par\smallskip
...
The repository draft of \textsc{05} contained a LaTeX parse error
...
Chapter \textsc{05} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_05.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{05}.
