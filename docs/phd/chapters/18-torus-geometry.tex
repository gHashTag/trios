...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v514/v514-18-torus-geometry.png}}
\caption{Azbuka of the Tridevyatoe — the magic ring: the ring / the donut / the moebius (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch18-limitations.png}}
\caption{Limitations (legacy)}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs-18-torus.png}}
\caption{Engraved triptych for Chapter~18 — \textit{The Torus, The Cycle, The Flow} — toroidal $\varphi$-flows in cognitive state space.}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs2-18-torus.png}}
\caption{Engraved triptych companion to the Chapter~18 abstract — \textit{The Ring, The Tube, The Flow} — toroidal phi-graded geodesic flow.}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-18-torus-a.png}}
\caption{Architectural-blueprint triptych: the tube / the ring / the topology (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
