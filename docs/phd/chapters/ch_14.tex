...
\caption{Azbuka triptych: Eval Semantics: The BPB Metric (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Hardware Bridge (deferred) (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\section{2. BPB: Definition and Algebraic Properties}\label{bpb-definition-and-algebraic-properties}

\subsection{2.1 Cross-Entropy and Perplexity}\label{cross-entropy-and-perplexity}
...
\subsection{2.2 Byte-Level Normalisation}\label{byte-level-normalisation}
...
\subsection{2.3 φ-Weighted BPB}\label{ux3c6-weighted-bpb}
...
\section{3. Gate Thresholds and Their Derivation}\label{gate-thresholds-and-their-derivation}

\subsection{3.1 Gate-2: BPB ≤ 1.85}\label{gate-2-bpb-1.85}
...
\subsection{3.2 Gate-3: BPB ≤ 1.50}\label{gate-3-bpb-1.50}
...
\subsection{3.3 Relationship to the DARPA Energy Goal}\label{relationship-to-the-darpa-energy-goal}
