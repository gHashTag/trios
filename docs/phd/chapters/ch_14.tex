...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_14.jpg}}
\caption{Architectural-blueprint triptych: bit, budget, and BPB lower bound (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
