...
% Original file moved to docs/phd/quarantine/ch\_14.tex (LaTeX parse error).
...
\section*{Deferred chapter: 14}
\addcontentsline{toc}{section}{Deferred chapter: 14}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_14.tex}\par\smallskip
...
The repository draft of \textsc{14} contained a LaTeX parse error
...
Chapter \textsc{14} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_14.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{14}.
