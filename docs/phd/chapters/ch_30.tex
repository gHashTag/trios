...
\caption{Azbuka triptych: Trinity SAI: Vector Symbolic Architecture and Associative Recall (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — GF vs MXFP4 Ablation (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Deferred chapter: Agent Memory (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
