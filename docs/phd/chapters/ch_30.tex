...
% Original file moved to docs/phd/quarantine/ch\_30.tex (LaTeX parse error).
...
\section*{Deferred chapter: 30}
\addcontentsline{toc}{section}{Deferred chapter: 30}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_30.tex}\par\smallskip
...
The repository draft of \textsc{30} contained a LaTeX parse error
...
Chapter \textsc{30} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_30.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{30}.
