...
\caption{Codex Binding - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka, v5.21).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v520-32-aqueduct.jpg}}
\caption{Aqueduct - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka, v5.21).}
\end{figure}
