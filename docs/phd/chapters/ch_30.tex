...
\caption{Triptych illustrating the chapter 'Trinity SAI: Vector Symbolic Architecture and Associative Recall' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\caption{Ch 26 - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
