...
\caption{Azbuka triptych: Standard-Model phi-Parametrizations: 42 Precision Fits (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Kepler Solids: BPB Benchmark --- Railway PostgreSQL Write (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
