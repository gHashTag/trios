...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_00.jpg}}
\caption{Architectural-blueprint triptych: Standard-Model particles, forces, and symmetries (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
