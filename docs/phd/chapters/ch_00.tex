...
\caption{Triptych illustrating the chapter 'Standard-Model phi-Parametrizations: 42 Precision Fits' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
