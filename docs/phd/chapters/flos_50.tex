...
along two interleaved families of spirals---one winding clockwise, the
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{W8-50-360-grid-phi.png}
  \caption{THE GRID / THE PHI / THE DISTANCE. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave8-W8-50-360-grid-phi}
\end{figure}
