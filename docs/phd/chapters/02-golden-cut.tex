...
% Original file moved to docs/phd/quarantine/02-golden-cut.tex (LaTeX parse error).
...
\section*{Deferred chapter: Golden Cut}
\addcontentsline{toc}{section}{Deferred chapter: Golden Cut}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/02-golden-cut.tex}\par\smallskip
...
The repository draft of \textsc{Golden Cut} contained a LaTeX parse error
...
Chapter \textsc{Golden Cut} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/02-golden-cut.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Golden Cut}.
