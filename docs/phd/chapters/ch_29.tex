...
% Original file moved to docs/phd/quarantine/ch\_29.tex (LaTeX parse error).
...
\section*{Deferred chapter: 29}
\addcontentsline{toc}{section}{Deferred chapter: 29}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_29.tex}\par\smallskip
...
The repository draft of \textsc{29} contained a LaTeX parse error
...
Chapter \textsc{29} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_29.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{29}.
