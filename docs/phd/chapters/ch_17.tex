...
% Original file moved to docs/phd/quarantine/ch\_17.tex (LaTeX parse error).
...
\section*{Deferred chapter: 17}
\addcontentsline{toc}{section}{Deferred chapter: 17}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_17.tex}\par\smallskip
...
The repository draft of \textsc{17} contained a LaTeX parse error
...
Chapter \textsc{17} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_17.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{17}.
