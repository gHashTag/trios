...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_17.png}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_17.png}}
\caption{Architectural-blueprint triptych: ablation baseline, variant, and $\Delta$ heatmap (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_17-a.png}}
\caption{Architectural-blueprint triptych: the cell / the row / the matrix (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
