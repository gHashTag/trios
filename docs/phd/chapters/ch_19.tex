...
\section*{Statistical Analysis (Welch-$t$)}
\addcontentsline{toc}{section}{Statistical Analysis (Welch-$t$)}
...
\subsection{2. Test Design and Hypotheses}\label{test-design-and-hypotheses}
...
\subsection{\texorpdfstring{3. Welch \(t\)-Statistic and Degrees of Freedom}{3. Welch t-Statistic and Degrees of Freedom}}\label{welch-t-statistic-and-degrees-of-freedom}
...
{[}1{]} \texttt{igla\_assertions.json} runtime-mirror contract, key \texttt{stat\_test\_preregistration}. https://github.com/gHashTag/t27/blob/feat/canonical-coq-home/proofs/canonical/igla/INV2\_IglaAshaBound.v
...
{[}13{]} \texttt{gHashTag/trios\#419} --- Ch.25 scope (for cross-reference). https://github.com/gHashTag/trios/issues/419
