...
% Original file moved to docs/phd/quarantine/ch\_19.tex (LaTeX parse error).
...
\section*{Deferred chapter: 19}
\addcontentsline{toc}{section}{Deferred chapter: 19}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_19.tex}\par\smallskip
...
The repository draft of \textsc{19} contained a LaTeX parse error
...
Chapter \textsc{19} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_19.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{19}.
