...
\caption{Azbuka triptych: Statistical Analysis (Welch-t) (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Energy 3000DARPA (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\section{2. Test Design and Hypotheses}\label{test-design-and-hypotheses}
...
\section{\texorpdfstring{3. Welch \(t\)-Statistic and Degrees of Freedom}{3. Welch t-Statistic and Degrees of Freedom}}\label{welch-t-statistic-and-degrees-of-freedom}
