...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.18\linewidth,keepaspectratio]{13-metatron-cube.png}}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch16-360-lane-grid.png}}
\caption{360-lane grid (legacy)}
\end{figure}
...
\caption{Flower of Life — the precursor lattice from which Metatron's Cube is derived; its 19 circle centres encode the projection map onto the five Platonic solids that anchor the chapter's geometric proof.}
\end{figure}
...
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{14-platonic-solids.png}}
\caption{The five Platonic solids inscribed in Metatron's Cube. Their vertex counts $\{4,6,8,12,20\}$ saturate the φ-graded vertex algebra and provide the closed-form constants used in the energy-budget calculations.}
\end{figure}
