...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-13-metatron-cube.png}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-13-metatron-a.png}}
\caption{Metatron's cube architectures: the cube / the star / the orbit (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-13-metatron-b.png}}
\caption{Metatron's cube architectures: the tetra / the octa / the dodeca (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-13-metatron-c.png}}
\caption{Metatron's cube architectures: the 13 / the 12 / the 1 (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
