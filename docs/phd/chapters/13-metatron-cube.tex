...
\caption{Azbuka of the Tridevyatoe — Metatron's cube: the cube / the star / the solid (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Royal Coin Press (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — IGLA RACE (Multi-Agent Fleet) (variant c) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Lens Grinding Wheel (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — QMTech XC7A100T FPGA (variant d) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Trinity GF16 ASIC as a Self-Sovereign dePIN Mesh Node: Zero-DSP Inference and On-Chip Routing at 50,mW (variant e) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — The Golden Bridge: Fibonacci-Lucas Generating Functions (figure c) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
