...
\caption{Momentum Algebra - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka, v5.21).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-31-philosophy.jpg}}
\caption{Philosophy - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka, v5.21).}
\end{figure}
