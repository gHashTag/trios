...
\caption{Triptych illustrating the chapter 'Metatron's Cube and the Lucas-12 Orbit' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\caption{Ink Quill - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
...
\caption{Ch 34 - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
