...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_04.png}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_04.png}}
\caption{Architectural-blueprint triptych: field, force, and $\alpha_\varphi$ derivation (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_04-a.png}}
\caption{Architectural-blueprint triptych: the alpha / the phi / the formula (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
