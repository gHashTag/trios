...
\section{2. Derivation of the Closed Form}\label{derivation-of-the-closed-form}
...
\section{3. Multiplicative Identity and Kernel Integration}\label{multiplicative-identity-and-kernel-integration}
