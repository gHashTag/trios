...
% Original file moved to docs/phd/quarantine/ch\_04.tex (LaTeX parse error).
...
\section*{Deferred chapter: 04}
\addcontentsline{toc}{section}{Deferred chapter: 04}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_04.tex}\par\smallskip
...
The repository draft of \textsc{04} contained a LaTeX parse error
...
Chapter \textsc{04} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_04.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{04}.
