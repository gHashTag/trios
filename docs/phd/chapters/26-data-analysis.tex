...
% Original file moved to docs/phd/quarantine/26-data-analysis.tex (LaTeX parse error).
...
\section*{Deferred chapter: Data Analysis}
\addcontentsline{toc}{section}{Deferred chapter: Data Analysis}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/26-data-analysis.tex}\par\smallskip
...
The repository draft of \textsc{Data Analysis} contained a LaTeX parse error
...
Chapter \textsc{Data Analysis} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/26-data-analysis.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Data Analysis}.
