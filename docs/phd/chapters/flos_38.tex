...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{W8-38-sacred-alpha-phi.png}
  \caption{THE ALPHA / THE PHI / THE DERIVATION. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave8-W8-38-sacred-alpha-phi}
\end{figure}
