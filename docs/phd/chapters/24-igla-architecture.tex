...
% Original file moved to docs/phd/quarantine/24-igla-architecture.tex (LaTeX parse error).
...
\section*{Deferred chapter: Igla Architecture}
\addcontentsline{toc}{section}{Deferred chapter: Igla Architecture}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/24-igla-architecture.tex}\par\smallskip
...
The repository draft of \textsc{Igla Architecture} contained a LaTeX parse error
...
Chapter \textsc{Igla Architecture} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/24-igla-architecture.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Igla Architecture}.
