...
% Original file moved to docs/phd/quarantine/ch\_22.tex (LaTeX parse error).
...
\section*{Deferred chapter: 22}
\addcontentsline{toc}{section}{Deferred chapter: 22}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_22.tex}\par\smallskip
...
The repository draft of \textsc{22} contained a LaTeX parse error
...
Chapter \textsc{22} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_22.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{22}.
