...
\caption{Standard Model parameter table laid out in engraved-triptych form — each fundamental constant cross-referenced to its φ-derivation in Chapter 20.}
\end{figure}
