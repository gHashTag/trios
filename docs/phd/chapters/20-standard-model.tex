...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-20-standard-model.png}}
\caption{Azbuka of the Tridevyatoe — the standard model: the quark / the force / the symmetry (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-20-standard-model-a.png}}
\caption{Standard-Model lattice: the quark / the lepton / the boson (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-20-standard-model-b.png}}
\caption{Standard-Model lattice: the strong / the weak / the em (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\section{Falsification Criterion}\label{sec:20-falsify}
