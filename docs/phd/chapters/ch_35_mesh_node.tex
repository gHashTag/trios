...
\caption{Triptych illustrating the chapter 'Trinity GF16 ASIC as a Self-Sovereign dePIN Mesh Node: Zero-DSP Inference and On-Chip Routing at <50,mW' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\caption{Ch 31 - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
