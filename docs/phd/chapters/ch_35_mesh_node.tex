...
\caption{Azbuka of the Tridevyatoe — Golden Scales: Sacred Formula Derivation (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — ACM Artifact Evaluation Checklist (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
