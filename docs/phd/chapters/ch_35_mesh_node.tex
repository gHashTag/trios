...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_35_mesh_node.png}}
\caption{Azbuka of the Tridevyatoe — ch\_35\_mesh\_node: the web / the node / the beacon (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_35_mesh_node.png}}
\caption{Architectural-blueprint triptych: GF16 ASIC node, mesh, and sovereign seal (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_35_mesh_node-a.png}}
\caption{Mesh-node topology: the node / the peer / the consensus (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_35_mesh_node-b.png}}
\caption{Mesh-node topology: the compute / the stake / the reward (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
