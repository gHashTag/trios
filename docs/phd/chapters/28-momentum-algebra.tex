...
\caption{Triptych illustrating the chapter 'Momentum Algebra: QMTech XC7A100T FPGA' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\caption{Azbuka Alpha - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
