...
% Original file moved to docs/phd/quarantine/28-momentum-algebra.tex (LaTeX parse error).
...
\section*{Deferred chapter: Momentum Algebra}
\addcontentsline{toc}{section}{Deferred chapter: Momentum Algebra}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/28-momentum-algebra.tex}\par\smallskip
...
The repository draft of \textsc{Momentum Algebra} contained a LaTeX parse error
...
Chapter \textsc{Momentum Algebra} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/28-momentum-algebra.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Momentum Algebra}.
