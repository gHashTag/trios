...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-28-momentum-algebra.png}}
\caption{Azbuka of the Tridevyatoe — the momentum: the ball / the path / the collision (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch28-qmtech-xc7a100t-fpga.png}}
\caption{QMTech XC7A100T FPGA (legacy)}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs-28-momentum.png}}
\caption{Engraved triptych for Chapter~28 — \textit{The Mass, The Velocity, The Momentum} — momentum algebra as a $\varphi$-graded Lie operad.}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs2-28-momentum.png}}
\caption{Engraved triptych companion to the Chapter~28 abstract — \textit{The Mass, The Velocity, The Product} — phi-graded momentum diagram.}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-28-momentum-a.png}}
\caption{Architectural-blueprint triptych: the momentum / the algebra / the invariant (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
