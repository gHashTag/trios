...
The kernel lemmas \texttt{trit\_mul\_zero\_l} and
\texttt{trit\_mul\_zero\_r} (KER-8, Ch.4) certify
...
\subsection{2. Architecture: Zero-DSP Ternary
...
\subsection{3. Resource Utilisation and Timing
...
\texttt{trit\_mul\_zero\_l} and
\texttt{trit\_mul\_zero\_r} (Ch.4, KER-8)
...
\texttt{gHashTag/trinity-fpga} contains the HDL
...
chapter relies on \texttt{trit\_mul\_zero\_l} and
\texttt{trit\_mul\_zero\_r} (KER-8,
...
\item
  ...
  \texttt{gHashTag/trinity-fpga} --- Status:
...
[4] \texttt{gHashTag/trinity-fpga} --- Trinity
...
(KER-8 \texttt{trit\_mul\_zero\_l},
...
[12] \texttt{gHashTag/trios\#422} --- Ch.28
