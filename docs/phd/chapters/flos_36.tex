...
\begin{tcolorbox}[colback=blue!3,colframe=blue!40!black,title={\textbf{Trinity S\textsuperscript{3}AI Strand} \textbf{Ch.2}}]
  ...
  \textbf{Lane:} S2 (Trinity strand) \\
  \textbf{Theorems in chapter:} 2 \\
...
\section{Abstract}\label{ch_02:abstract}
...
\section{1. Introduction}\label{ch_02:introduction}
...
\section{2. Taxonomy of Neuro-Symbolic Paradigms}\label{ch_02:taxonomy-of-neuro-symbolic-paradigms}

\subsection{2.1 Early Symbolic--Connectionist Hybrids}\label{ch_02:early-symbolicconnectionist-hybrids}
...
\subsection{2.2 Logic Tensor Networks and Differentiable Reasoning}\label{ch_02:logic-tensor-networks-and-differentiable-reasoning}
...
\subsection{2.3 Sparse and Ternary Neural Computation}\label{ch_02:sparse-and-ternary-neural-computation}
...
\subsection{2.4 Vector Symbolic Architectures}\label{ch_02:vector-symbolic-architectures}
...
\section{3. Representational Bottleneck and the \(\varphi\)-Structural Prior}\label{ch_02:representational-bottleneck-and-the-ux3c6-structural-prior}

\subsection{3.1 The Normalisation Problem}\label{ch_02:the-normalisation-problem}
...
\subsection{3.2 Fibonacci and Lucas Lattices as Basis Sets}\label{ch_02:fibonacci-and-lucas-lattices-as-basis-sets}
...
\subsection{3.3 Gap in Prior Art}\label{ch_02:gap-in-prior-art}
...
\section{4. Results / Evidence}\label{ch_02:results-evidence}
...
\section{References}\label{ch_02:references}
...
and Networks (KANs)}\label{ch_02:ch2-s1-kart-kan}
...
\section{S2. Finite-Field Expressivity}\label{ch_02:ch2-s2-finite-field}
...
\section{S3. Ternary and Sub-Bit Neural Computation}\label{ch_02:ch2-s3-ternary}
...
\section{S4. Vector-Symbolic Architectures and Group Algebras}\label{ch_02:ch2-s4-vsa}
...
\section{S5. Logic Tensor Networks and Differentiable Reasoning}\label{ch_02:ch2-s5-ltn}
...
\section{S6. The Three Cliffs and How Trinity S$^3$AI Clears Them}\label{ch_02:ch2-s6-cliffs}
...
\section{S7. The Gap This Dissertation Fills}\label{ch_02:ch2-s7-gap}
...
\section{S8. Theorem Cross-Reference}\label{ch_02:ch2-s8-theorems}
...
\label{ch_02:thm:ch2-phi-square}
\(\varphi^{2}=\varphi+1\).
\textbf{Status:} \texttt{Qed} in
\filepath{docs/phd/theorems/trinity/CorePhi.v}.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{W8-36-bg-neurosymbolic.png}
  \caption{THE NEURAL / THE SYMBOLIC / THE BRIDGE. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave8-W8-36-bg-neurosymbolic}
\end{figure}
