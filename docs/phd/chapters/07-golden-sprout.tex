...
% Original file moved to docs/phd/quarantine/07-golden-sprout.tex (LaTeX parse error).
...
\section*{Deferred chapter: Golden Sprout}
\addcontentsline{toc}{section}{Deferred chapter: Golden Sprout}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/07-golden-sprout.tex}\par\smallskip
...
The repository draft of \textsc{Golden Sprout} contained a LaTeX parse error
...
Chapter \textsc{Golden Sprout} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/07-golden-sprout.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Golden Sprout}.
