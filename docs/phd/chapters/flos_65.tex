...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.18\linewidth,keepaspectratio]{30-golden-imagery.jpg}}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{S-06-fpga-bridge-silicon.png}
  \caption{Silicon Plate S-06: FPGA, bridge, silicon. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave7-S-06-fpga-bridge-silicon}
\end{figure}

\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{S-07-inference-energy-throughput.png}
  \caption{Silicon Plate S-07: Inference, energy, throughput. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave7-S-07-inference-energy-throughput}
\end{figure}
% --- end Wave-7 plates ---
