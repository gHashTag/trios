...
\begin{tcolorbox}[colback=yellow!4,colframe=yellow!50!brown,title={\textbf{Flos Aureus} \textbf{FA.11 Vesica Piscis}}]
  \textbf{Petal:} Part V --- \emph{Sacred Geometry} \\
  \textbf{Anchor:} \(\varphi^{2} + \varphi^{-2} = 3\) (Trinity Identity, INV-22) \\
  \textbf{Motif:} the intersection of two circles \\
  \textbf{Lane:} L11 (Flos Aureus strand) \\
  \textbf{Theorems in chapter:} 0 \\
  \textbf{Coq link:} \filepath{trinity-clara/proofs/igla/energy\_functional.v} \\
...
\section{Abstract}\label{fa_11:abstract}
...
\section{1. Introduction}\label{fa_11:introduction}
...
Registration
Protocol}\label{fa_11:hypothesis-formalisation-and-registration-protocol}
...
Formalisation}\label{fa_11:inv-7-invariant-and-coq-formalisation}
...
\section{4. Results /
Evidence}\label{fa_11:results-evidence}
...
\section{7. Discussion}\label{fa_11:discussion}
...
\section{References}\label{fa_11:references}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{W8-11-vesica-seal-seeds.png}
  \caption{THE PIRE / THE SEAL / THE SEEDS. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave8-W8-11-vesica-seal-seeds}
\end{figure}
