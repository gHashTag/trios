...
% Original file moved to docs/phd/quarantine/ch\_34.tex (LaTeX parse error).
...
\section*{Deferred chapter: 34}
\addcontentsline{toc}{section}{Deferred chapter: 34}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_34.tex}\par\smallskip
...
The repository draft of \textsc{34} contained a LaTeX parse error
...
Chapter \textsc{34} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_34.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{34}.
