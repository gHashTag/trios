...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_34.jpg}}
\caption{Architectural-blueprint triptych: watt, op count, and $3000\times$ DARPA efficiency (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
