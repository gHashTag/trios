...
\caption{Azbuka triptych: Energy 3000DARPA (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\section{2. Energy Accounting Framework}\label{energy-accounting-framework}
...
\section{3. Ternary Mechanism Analysis}\label{ternary-mechanism-analysis}
