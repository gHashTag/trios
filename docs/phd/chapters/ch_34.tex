...
\section*{Energy 3000\(\times\) DARPA}
\addcontentsline{toc}{section}{Energy 3000\(\times\) DARPA}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,keepaspectratio]{ch34-energy-3000x-darpa.png}
...
\subsection{2. Energy Accounting Framework}\label{energy-accounting-framework}
...
\subsection{3. Ternary Mechanism Analysis}\label{ternary-mechanism-analysis}
...
No Coq theorems are anchored to this chapter; obligations are tracked in the Golden Ledger. The chapter relies on \texttt{trit\_mul\_zero\_l}, \texttt{trit\_mul\_zero\_r} (KER-8, Ch.4), and the INV-1 BPB monotone-backward invariant (Ch.10) as pre-conditions for the efficiency claims.
...
{[}9{]} \texttt{gHashTag/trios\#428} --- Ch.34 scope directive. GitHub issue tracker.

{[}10{]} \texttt{gHashTag/trinity-fpga} --- Trinity FPGA HDL repository. GitHub.
