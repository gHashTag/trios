...
% Original file moved to docs/phd/quarantine/25-benchmarks.tex (LaTeX parse error).
...
\section*{Deferred chapter: Benchmarks}
\addcontentsline{toc}{section}{Deferred chapter: Benchmarks}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/25-benchmarks.tex}\par\smallskip
...
The repository draft of \textsc{Benchmarks} contained a LaTeX parse error
...
Chapter \textsc{Benchmarks} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/25-benchmarks.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Benchmarks}.
