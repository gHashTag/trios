...
% Original file moved to docs/phd/quarantine/ch\_18.tex (LaTeX parse error).
...
\section*{Deferred chapter: 18}
\addcontentsline{toc}{section}{Deferred chapter: 18}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_18.tex}\par\smallskip
...
The repository draft of \textsc{18} contained a LaTeX parse error
...
Chapter \textsc{18} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_18.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{18}.
