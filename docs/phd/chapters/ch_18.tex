...
\subsection{2. State-of-the-Art Comparison (CLARA-SOA Snapshot)}\label{state-of-the-art-comparison-clara-soa-snapshot}
...
\subsection{3. Coq.Interval Upgrade Lane}\label{coq.interval-upgrade-lane}
...
\subsection{4. Hardware and Runtime Limitations}\label{hardware-and-runtime-limitations}
...
{[}8{]} Dettmers, T. et al.~(2022). LLM.int8(): 8-bit Matrix Multiplication for Transformers at Scale. \emph{NeurIPS 2022}. https://arxiv.org/abs/2208.07339
