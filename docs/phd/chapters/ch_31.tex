...
\caption{Triptych illustrating the chapter 'Hardware Empirical (1003 toks HSLM)' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\caption{Ch 27 - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
