...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v514/v514-ch_31.png}}
\caption{Azbuka of the Tridevyatoe — ch\_31: the compass / the map / the star (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}


\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch31-hardware-empirical.png}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_31-a.png}}
\caption{Architectural-blueprint triptych: the one / the trinity / the all (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
