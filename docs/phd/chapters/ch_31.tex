...
\subsection{2. Hardware Architecture}\label{hardware-architecture}
...
\subsection{3. Formal Seal: 297 Coq Theorems}\label{formal-seal-297-coq-theorems}

The accelerator RTL was generated from a Coq-extracted OCaml reference, ensuring that the implemented arithmetic is a direct realisation of the formally verified specification. The seal consists of 297 closed \texttt{Qed} theorems across 65 \texttt{.v} files in \texttt{t27/proofs/canonical/}, organised into the following families:
...
No Coq theorems are anchored exclusively to this chapter; the 297-theorem seal is a corpus-level result reported here for completeness. The \texttt{hw/} family theorems are catalogued in App.F.
...
\tightlist
\item
  \textbf{B004} (DOI, golden) --- Queen Lotus Adaptive Reasoning. https://doi.org/10.5281/zenodo.19227871 --- Linked: Ch.31, App.H.
\item
  \textbf{QMTECH-XC7A100T} (hw, golden) --- Xilinx Artix-7, 0 DSP, 63 toks/sec @ 92 MHz, 1 W. https://github.com/gHashTag/trinity-fpga --- Linked: Ch.28, Ch.31, Ch.34, App.F, App.I.
\end{itemize}
...
{[}2{]} QMTech. \emph{XC7A100T FPGA Development Board User Manual}, 2023. https://github.com/gHashTag/trinity-fpga

{[}3{]} Xilinx (AMD). \emph{Vivado Design Suite User Guide: Implementation}, UG904 (v2024.1). MMCM configuration.

{[}4{]} \texttt{gHashTag/t27/proofs/canonical/hw/} --- 8 files, 35 \texttt{Qed} TMAC correctness theorems. https://github.com/gHashTag/t27/tree/feat/canonical-coq-home/proofs/canonical/
...
{[}12{]} \texttt{gHashTag/trios\#419} --- Evidence axis 3 scope. https://github.com/gHashTag/trios/issues/419

{[}13{]} This dissertation, App.F --- Hardware Coq Family (\texttt{hw/}). 35 \texttt{Qed} theorems.
