...
% Original file moved to docs/phd/quarantine/ch\_31.tex (LaTeX parse error).
...
\section*{Deferred chapter: 31}
\addcontentsline{toc}{section}{Deferred chapter: 31}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_31.tex}\par\smallskip
...
The repository draft of \textsc{31} contained a LaTeX parse error
...
Chapter \textsc{31} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_31.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{31}.
