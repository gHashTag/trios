...
% Original file moved to docs/phd/quarantine/33-epilogue.tex (LaTeX parse error).
...
\section*{Deferred chapter: Epilogue}
\addcontentsline{toc}{section}{Deferred chapter: Epilogue}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/33-epilogue.tex}\par\smallskip
...
The repository draft of \textsc{Epilogue} contained a LaTeX parse error
...
Chapter \textsc{Epilogue} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/33-epilogue.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Epilogue}.
