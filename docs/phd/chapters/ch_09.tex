...
% Original file moved to docs/phd/quarantine/ch\_09.tex (LaTeX parse error).
...
\section*{Deferred chapter: 09}
\addcontentsline{toc}{section}{Deferred chapter: 09}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_09.tex}\par\smallskip
...
The repository draft of \textsc{09} contained a LaTeX parse error
...
Chapter \textsc{09} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_09.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{09}.
