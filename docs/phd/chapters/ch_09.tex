...
\caption{Azbuka triptych: GF vs MXFP4 Ablation (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — The Golden Bridge: Fibonacci-Lucas Generating Functions (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
