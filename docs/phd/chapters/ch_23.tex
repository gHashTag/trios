...
% Original file moved to docs/phd/quarantine/ch\_23.tex (LaTeX parse error).
...
\section*{Deferred chapter: 23}
\addcontentsline{toc}{section}{Deferred chapter: 23}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_23.tex}\par\smallskip
...
The repository draft of \textsc{23} contained a LaTeX parse error
...
Chapter \textsc{23} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_23.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{23}.
