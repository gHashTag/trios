...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v520-13-spectacle-lens.jpg}}
\caption{Triptych illustrating the chapter 'MCP integration' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_19.jpg}}
\caption{Ch 19 - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
