...
\caption{Azbuka triptych: MCP integration (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Background: Neuro-Symbolic AI (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\section{2. MCP Adapter Layer Architecture}\label{mcp-adapter-layer-architecture}
...
\section{3. Protocol Implementation and Latency Analysis}\label{protocol-implementation-and-latency-analysis}
