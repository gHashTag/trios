...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.18\linewidth,keepaspectratio]{00-monad.png}}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch01-introduction.png}}
\caption{Legacy frontispiece (v1.0)}
\end{figure}
...
\caption{Trinity identity \(\varphi^2+\varphi^{-2}=3\) closure}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{app-a-cover-abstract.png}}
\caption{Catalogue cover plate}
\end{figure}
