...
\caption{Azbuka of the Tridevyatoe — the Platonic solids: the tetra / the octa / the dodeca (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch14-eval-semantics.png}}
\caption{Evaluation semantics (legacy)}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs-14-platonic.png}}
\caption{Engraved triptych for Chapter~14 — \textit{The Tetra, The Cube, The Icosa} — Platonic solids as carriers of the golden ratio in 3-space.}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs2-14-platonic.png}}
\caption{Engraved triptych companion to the Chapter~14 abstract — \textit{The Face, The Net, The Solid} — unfolded Platonic-solid nets next to their assembled forms.}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-14-platonic-a.jpg}}
\caption{Architectural-blueprint triptych: the tetrahedron / the octahedron / the icosahedron (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
