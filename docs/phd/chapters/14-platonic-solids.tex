...
% Original file moved to docs/phd/quarantine/14-platonic-solids.tex (LaTeX parse error).
...
\section*{Deferred chapter: Platonic Solids}
\addcontentsline{toc}{section}{Deferred chapter: Platonic Solids}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/14-platonic-solids.tex}\par\smallskip
...
The repository draft of \textsc{Platonic Solids} contained a LaTeX parse error
...
Chapter \textsc{Platonic Solids} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/14-platonic-solids.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Platonic Solids}.
