...
\subsection{2. BPB: Definition and Algebraic
Properties}\label{bpb-definition-and-algebraic-properties}

\subsubsection{2.1 Cross-Entropy and
...
\subsection{3. Gate Thresholds and Their
Derivation}\label{gate-thresholds-and-their-derivation}

\subsubsection{3.1 Gate-2: BPB ≤
...
\subsubsection{3.3 Relationship to the DARPA
Energy
