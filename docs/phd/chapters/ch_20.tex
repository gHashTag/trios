...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v520-22-quill-formula.jpg}}
\caption{Quill Formula - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka, v5.21).}
\end{figure}
\begin{quote}\itshape
...
\caption{Stone Arch - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka, v5.21).}
\end{figure}
