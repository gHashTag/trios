...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,keepaspectratio]{ch20-reproducibility.png}
...
\subsection{2. Sanctioned Seed Protocol}\label{sanctioned-seed-protocol}

\subsubsection{2.1 Algebraic Basis}\label{algebraic-basis}
...
\subsubsection{2.2 Seed Assignment to Experiments}\label{seed-assignment-to-experiments}
...
\subsubsection{2.3 Seed Verification}\label{seed-verification}
...
\subsection{3. Hardware and Software Specification}\label{hardware-and-software-specification}

\subsubsection{3.1 Hardware Pinning}\label{hardware-pinning}
...
\subsubsection{3.2 Software Environment}\label{software-environment}
...
\subsubsection{3.3 Non-Determinism Budget}\label{non-determinism-budget}
...
{[}4{]} trinity-fpga repository. \texttt{gHashTag/trinity-fpga}. GitHub. https://github.com/gHashTag/trinity-fpga.

{[}5{]} Trinity Canonical Coq Home. \texttt{Trinity.Canonical.Kernel.Semantics}. \texttt{gHashTag/t27/proofs/canonical/}.
