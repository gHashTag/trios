...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_20.png}}
\caption{Azbuka of the Tridevyatoe — ch\_20: the lantern / the wick / the flame (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}


\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch20-reproducibility.png}}
...
\section{2. Sanctioned Seed Protocol}\label{sanctioned-seed-protocol}

\subsection{2.1 Algebraic Basis}\label{algebraic-basis}
...
\subsection{2.2 Seed Assignment to Experiments}\label{seed-assignment-to-experiments}
...
\subsection{2.3 Seed Verification}\label{seed-verification}
...
\section{3. Hardware and Software Specification}\label{hardware-and-software-specification}

\subsection{3.1 Hardware Pinning}\label{hardware-pinning}
...
\subsection{3.2 Software Environment}\label{software-environment}
...
\subsection{3.3 Non-Determinism Budget}\label{non-determinism-budget}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_20-a.png}}
\caption{Architectural-blueprint triptych: the manifest / the badge / the artefact (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
