...
% Original file moved to docs/phd/quarantine/ch\_20.tex (LaTeX parse error).
...
\section*{Deferred chapter: 20}
\addcontentsline{toc}{section}{Deferred chapter: 20}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_20.tex}\par\smallskip
...
The repository draft of \textsc{20} contained a LaTeX parse error
...
Chapter \textsc{20} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_20.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{20}.
