...
\caption{Azbuka of the Tridevyatoe — Trinity GF16 ASIC as a Self-Sovereign dePIN Mesh Node: Zero-DSP Inference and On-Chip Routing at 50,mW (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
