...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{34-depin-mesh.jpg}
  \caption{Trinity GF16 ASIC as a self-sovereign dePIN mesh node: zero-multiplier silicon, $\varphi^2+\varphi^{-2}=3$.}
  \label{fig:hero-flos-69}
\end{figure}
...
\begin{lstlisting}[basicstyle=\ttfamily\small, caption={\texttt{crates/trios-mesh/src/lib.rs} — public API sketch}]
#![no_std]
#![deny(unsafe_code)]
