...
% Original file moved to docs/phd/quarantine/ch\_27.tex (LaTeX parse error).
...
\section*{Deferred chapter: 27}
\addcontentsline{toc}{section}{Deferred chapter: 27}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_27.tex}\par\smallskip
...
The repository draft of \textsc{27} contained a LaTeX parse error
...
Chapter \textsc{27} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_27.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{27}.
