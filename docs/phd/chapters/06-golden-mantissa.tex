...
% Original file moved to docs/phd/quarantine/06-golden-mantissa.tex (LaTeX parse error).
...
\section*{Deferred chapter: Golden Mantissa}
\addcontentsline{toc}{section}{Deferred chapter: Golden Mantissa}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/06-golden-mantissa.tex}\par\smallskip
...
The repository draft of \textsc{Golden Mantissa} contained a LaTeX parse error
...
Chapter \textsc{Golden Mantissa} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/06-golden-mantissa.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Golden Mantissa}.
