...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_12.jpg}}
\caption{Architectural-blueprint triptych: substrate, software-hardware bridge, and target die (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_12-a.jpg}}
\caption{Architectural-blueprint triptych: the wafer / the die / the package (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
