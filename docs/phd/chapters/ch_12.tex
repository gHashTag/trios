...
% Original file moved to docs/phd/quarantine/ch\_12.tex (LaTeX parse error).
...
\section*{Deferred chapter: 12}
\addcontentsline{toc}{section}{Deferred chapter: 12}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_12.tex}\par\smallskip
...
The repository draft of \textsc{12} contained a LaTeX parse error
...
Chapter \textsc{12} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_12.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{12}.
