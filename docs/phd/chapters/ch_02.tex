...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v514/v514-ch_02.png}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_02.png}}
\caption{Architectural-blueprint triptych: lineage, state, and frontier of neuro-symbolic AI (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_02-a.png}}
\caption{Architectural-blueprint triptych: the past / the present / the future (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_02-b.png}}
\caption{Architectural-blueprint triptych: the neuro / the symbol / the bridge (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
