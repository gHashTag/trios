...
% Original file moved to docs/phd/quarantine/ch\_02.tex (LaTeX parse error).
...
\section*{Deferred chapter: 02}
\addcontentsline{toc}{section}{Deferred chapter: 02}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_02.tex}\par\smallskip
...
The repository draft of \textsc{02} contained a LaTeX parse error
...
Chapter \textsc{02} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_02.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{02}.
