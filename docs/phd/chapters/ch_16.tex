...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_16.jpg}}
\caption{Azbuka triptych: 360-Lane Phi-Distance Grid (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\section{2. The Phi-Distance Function}\label{the-phi-distance-function}
...
\section{3. Grid Construction and Sparsity Analysis}\label{grid-construction-and-sparsity-analysis}
...
\caption{Azbuka of the Tridevyatoe — Conclusion — The Golden Monograph (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
