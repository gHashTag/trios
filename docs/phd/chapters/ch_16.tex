...
% Original file moved to docs/phd/quarantine/ch\_16.tex (LaTeX parse error).
...
\section*{Deferred chapter: 16}
\addcontentsline{toc}{section}{Deferred chapter: 16}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_16.tex}\par\smallskip
...
The repository draft of \textsc{16} contained a LaTeX parse error
...
Chapter \textsc{16} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_16.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{16}.
