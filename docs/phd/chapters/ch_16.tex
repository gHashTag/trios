...
\section*{360-Lane Phi-Distance Grid}
\addcontentsline{toc}{section}{360-Lane Phi-Distance Grid}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,keepaspectratio]{ch16-360-lane-grid.png}
...
\subsection{3. Grid Construction and Sparsity Analysis}\label{grid-construction-and-sparsity-analysis}
...
{[}6{]} \texttt{gHashTag/t27/proofs/canonical/igla/INV4\_NcaEntropyBand.v} --- INV-4 NCA 81=3⁴ (12 Qed).
...
{[}12{]} \texttt{gHashTag/trios\#408} --- Ch.16 scope directive. GitHub issue tracker.
