...
\caption{Azbuka triptych: UART v6 Protocol (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Philosophy — Mathematical Foundations (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\section{2. Frame Structure and Grammar}\label{frame-structure-and-grammar}

\subsection{2.1 Physical Layer}\label{physical-layer}
...
\subsection{2.2 Frame Grammar}\label{frame-grammar}
...
\subsection{2.3 CRC-16/CCITT Polynomial}\label{crc-16ccitt-polynomial}
...
\section{3. \(\varphi\)-Synchronisation Frames}\label{ux3c6-synchronisation-frames}

\subsection{3.1 Sync Frame Trigger}\label{sync-frame-trigger}
...
\subsection{3.2 Sync Frame Payload}\label{sync-frame-payload}
...
\subsection{3.3 Error Recovery Automaton}\label{error-recovery-automaton}
