...
% Original file moved to docs/phd/quarantine/ch\_32.tex (LaTeX parse error).
...
\section*{Deferred chapter: 32}
\addcontentsline{toc}{section}{Deferred chapter: 32}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_32.tex}\par\smallskip
...
The repository draft of \textsc{32} contained a LaTeX parse error
...
Chapter \textsc{32} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_32.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{32}.
