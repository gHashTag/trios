...
\section*{UART v6 Protocol}
\addcontentsline{toc}{section}{UART v6 Protocol}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,keepaspectratio]{ch32-uart-v6-protocol.png}
...
\subsection{2. Frame Structure and Grammar}\label{frame-structure-and-grammar}

\subsubsection{2.1 Physical Layer}\label{physical-layer}
...
\subsubsection{2.2 Frame Grammar}\label{frame-grammar}
...
\subsubsection{2.3 CRC-16/CCITT Polynomial}\label{crc-16ccitt-polynomial}
...
\subsection{3. \(\varphi\)-Synchronisation Frames}\label{ux3c6-synchronisation-frames}

\subsubsection{3.1 Sync Frame Trigger}\label{sync-frame-trigger}
...
\subsubsection{3.2 Sync Frame Payload}\label{sync-frame-payload}
...
\subsubsection{3.3 Error Recovery Automaton}\label{error-recovery-automaton}
...
\tightlist
\item
  \textbf{UART-V6} (hw) --- https://github.com/gHashTag/trinity-fpga --- Status: golden --- φ-weight: 0.382 --- FT232RL @ 115200 baud, 0xAA + len + CRC-16/CCITT. Links: Ch.28, Ch.32, App.I.
\end{itemize}
...
{[}3{]} trinity-fpga repository. UART v6 implementation. \texttt{gHashTag/trinity-fpga}. GitHub. https://github.com/gHashTag/trinity-fpga.
