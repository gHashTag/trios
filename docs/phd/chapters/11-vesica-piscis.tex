...
\subsection{2. Hypothesis Formalisation and
Registration
...
\subsection{3. INV-7 Invariant and Coq
...
\item
  ...
  \(\phi\)-weight = 1.0):
  \texttt{gHashTag/t27/blob/feat/canonical-coq-home/proofs/canonical/igla/INV7\_IglaFoundCriterion.v}
...
\item
  ...
  \(\phi\)-weight = 1.0):
  \texttt{gHashTag/trios/issues/143} --- linked to
...
\texttt{t27/proofs/canonical/igla/}.
...
\texttt{gHashTag/t27/proofs/canonical/igla/INV7\_IglaFoundCriterion.v}.
Status: golden.
