...
\caption{Azbuka of the Tridevyatoe — the vesica: the fish-eye / the lens / the almond (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch11-pre-registration.png}}
\caption{Pre-registration record (legacy)}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs-11-vesica.png}}
\caption{Engraved triptych for Chapter~11 — \textit{The Two, The Intersection, The Eye} — Vesica Piscis as the geometric womb of golden symmetries.}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs2-11-vesica.png}}
\caption{Engraved triptych companion to the Chapter~11 abstract — \textit{The Arc, The Crossing, The Lens} — Vesica Piscis as the geometric womb of phi-symmetries.}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-11-vesica-a.jpg}}
\caption{Architectural-blueprint triptych: the overlap / the lens / the axis (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
