...
% Original file moved to docs/phd/quarantine/ch\_10.tex (LaTeX parse error).
...
\section*{Deferred chapter: 10}
\addcontentsline{toc}{section}{Deferred chapter: 10}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_10.tex}\par\smallskip
...
The repository draft of \textsc{10} contained a LaTeX parse error
...
Chapter \textsc{10} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_10.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{10}.
