...
\caption{Azbuka of the Tridevyatoe — the golden bridge: the stone / the arch / the bridge (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — 360-Lane Phi-Distance Grid (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}

\begin{theorem}[Generating-function closed]
...
\caption{Azbuka of the Tridevyatoe — Sacred Formula: \_phi Derivation (variant b) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}

\begin{theorem}[Partial frac]
...
\caption{Azbuka of the Tridevyatoe — QMTech XC7A100T FPGA (figure c) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Pre-registration H₁ (3 distinct seeds) (variant c) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\begin{corollary}[Anchor via Generating-function]
...
\caption{Azbuka of the Tridevyatoe — Limitations (variant d) (Trinity S\textsuperscript{3}AI v5.19, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — BPB Benchmark + Railway PostgreSQL Write (figure c) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
...
\begin{corollary}[Matrix cassini]
