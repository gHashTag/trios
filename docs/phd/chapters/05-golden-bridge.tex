...
\caption{Fibonacci tesselation — the discrete analogue of the Golden-Bridge that connects the φ-graded ring to the integer lattice $\mathbb{Z}[\varphi]$. The tesselation density is precisely $\varphi^{-2}$.}
\end{figure}
...
\caption{Vesica piscis as the topological bridge between two unit circles separated by distance $\varphi^{-1}$ — the geometric primitive underlying the bridge construction in Theorem 5.7.}
\end{figure}
