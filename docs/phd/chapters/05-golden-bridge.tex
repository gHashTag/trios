...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-05-golden-bridge.png}}
...
\caption{Coq L1 Pareto (legacy generating-function bridge)}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-05-golden-bridge-a.png}}
\caption{Bridge of Fibonacci \& Lucas: the bank / the span / the pier (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-05-golden-bridge-b.png}}
\caption{Bridge of Fibonacci \& Lucas: the fibonacci / the lucas / the closure (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-05-golden-bridge-c.png}}
\caption{Bridge of Fibonacci \& Lucas: the generator / the function / the series (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
