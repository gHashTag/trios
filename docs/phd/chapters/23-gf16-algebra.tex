...
% Original file moved to docs/phd/quarantine/23-gf16-algebra.tex (LaTeX parse error).
...
\section*{Deferred chapter: Gf16 Algebra}
\addcontentsline{toc}{section}{Deferred chapter: Gf16 Algebra}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/23-gf16-algebra.tex}\par\smallskip
...
The repository draft of \textsc{Gf16 Algebra} contained a LaTeX parse error
...
Chapter \textsc{Gf16 Algebra} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/23-gf16-algebra.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Gf16 Algebra}.
