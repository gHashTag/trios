...
% Original file moved to docs/phd/quarantine/ch\_01.tex (LaTeX parse error).
...
\section*{Deferred chapter: 01}
\addcontentsline{toc}{section}{Deferred chapter: 01}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_01.tex}\par\smallskip
...
The repository draft of \textsc{01} contained a LaTeX parse error
...
Chapter \textsc{01} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_01.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{01}.
