...
\caption{Triptych illustrating the chapter 'Kepler Solids: BPB Benchmark --- Railway PostgreSQL Write' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\caption{Dome - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
