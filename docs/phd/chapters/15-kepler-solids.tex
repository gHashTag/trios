\chapter{Kepler Solids: BPB Benchmark --- Neon Write}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,keepaspectratio]{ch15-bpb-benchmark.png}
\caption*{Figure --- Kepler Solids: BPB Benchmark --- Neon Write.}
\end{figure}
...
complementary Neon write-back mechanism that
...
persistent, auditable store --- here the Neon
PostgreSQL database --- so that the IGLA RACE
...
\subsection{2. BPB Protocol and Monotone Backward
Invariant
(INV-1)}\label{bpb-protocol-and-monotone-backward-invariant-inv-1}

\subsubsection{2.1 Evaluation
...
never used; the Neon ingestion script rejects any
run metadata row containing those seed values.

\subsubsection{2.2 INV-1: BPB Monotone
Backward}\label{inv-1-bpb-monotone-backward}

\textbf{Invariant INV-1}
(\texttt{Trinity.Canonical.Igla.INV1\_BpbMonotoneBackward},
\texttt{t27/proofs/canonical/igla/INV1\_BpbMonotoneBackward.v}
[7]) states:
...
\subsection{3. Neon Write-Back
Architecture}\label{neon-write-back-architecture}

\subsubsection{3.1 Database
Schema}\label{database-schema}

The Neon PostgreSQL instance (project
...
\textbf{Neon write throughput:} 2,347 rows
...
\texttt{igla/} subdirectory of
\texttt{t27/proofs/canonical/}. The champion lr
...
\item
  ...
  \texttt{https://github.com/gHashTag/t27/blob/feat/canonical-coq-home/proofs/canonical/igla/INV1\_BpbMonotoneBackward.v}
...
The BPB benchmark protocol and Neon write-back
...
The Neon schema is also limited to a single
...
[7] gHashTag/t27,
\texttt{proofs/canonical/igla/INV1\_BpbMonotoneBackward.v}.
GitHub.
https://github.com/gHashTag/t27/blob/feat/canonical-coq-home/proofs/canonical/igla/INV1\_BpbMonotoneBackward.v

[8] gHashTag/trios, issue \#143 --- IGLA RACE
leaderboard. GitHub.
https://github.com/gHashTag/trios/issues/143
...
[13] Neon Database documentation.
