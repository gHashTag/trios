...
% Original file moved to docs/phd/quarantine/15-kepler-solids.tex (LaTeX parse error).
...
\section*{Deferred chapter: Kepler Solids}
\addcontentsline{toc}{section}{Deferred chapter: Kepler Solids}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/15-kepler-solids.tex}\par\smallskip
...
The repository draft of \textsc{Kepler Solids} contained a LaTeX parse error
...
Chapter \textsc{Kepler Solids} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/15-kepler-solids.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Kepler Solids}.
