...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-15-kepler-solids.png}}
\caption{Azbuka of the Tridevyatoe — the Kepler solids: the conjunction / the nesting / the cosmos (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch15-bpb-benchmark.png}}
\caption{BPB benchmark (legacy)}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs-15-kepler.png}}
\caption{Engraved triptych for Chapter~15 — \textit{The Star, The Compound, The Stellation} — Kepler--Poinsot stellations under the $\varphi$-anchor.}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs2-15-kepler.png}}
\caption{Engraved triptych companion to the Chapter~15 abstract — \textit{The Star, The Compound, The Stellation} — Kepler--Poinsot stellations after \emph{Harmonices Mundi} (1619).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-15-kepler-a.png}}
\caption{Architectural-blueprint triptych: the stella / the compound / the nest (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
