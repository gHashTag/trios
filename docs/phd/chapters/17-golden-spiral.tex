...
% Original file moved to docs/phd/quarantine/17-golden-spiral.tex (LaTeX parse error).
...
\section*{Deferred chapter: Golden Spiral}
\addcontentsline{toc}{section}{Deferred chapter: Golden Spiral}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/17-golden-spiral.tex}\par\smallskip
...
The repository draft of \textsc{Golden Spiral} contained a LaTeX parse error
...
Chapter \textsc{Golden Spiral} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/17-golden-spiral.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Golden Spiral}.
