...
\caption{Azbuka of the Tridevyatoe — Golden Mantissa: GoldenFloat Family GF4--GF64 (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Deferred chapter: Lexicon (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
...
\caption{Azbuka of the Tridevyatoe — Golden Spiral: Ablation Matrix (figure c) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
