...
\caption{Triptych illustrating the chapter 'Trinity Identity (2+⁻2=3)' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\caption{Falconry Glove - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
