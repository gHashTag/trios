...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v514/v514-ch_03.png}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_03.png}}
\caption{Architectural-blueprint triptych: lattice, facet, and Platonic solid of the $\varphi$-identity (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_03-a.png}}
\caption{Architectural-blueprint triptych: the square / the cube / the identity (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-ch_03-b.png}}
\caption{Architectural-blueprint triptych: the geometric / the algebraic / the numeric (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
