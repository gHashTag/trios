...
% Original file moved to docs/phd/quarantine/ch\_03.tex (LaTeX parse error).
...
\section*{Deferred chapter: 03}
\addcontentsline{toc}{section}{Deferred chapter: 03}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_03.tex}\par\smallskip
...
The repository draft of \textsc{03} contained a LaTeX parse error
...
Chapter \textsc{03} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_03.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{03}.
