...
% Original file moved to docs/phd/quarantine/ch\_15.tex (LaTeX parse error).
...
\section*{Deferred chapter: 15}
\addcontentsline{toc}{section}{Deferred chapter: 15}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_15.tex}\par\smallskip
...
The repository draft of \textsc{15} contained a LaTeX parse error
...
Chapter \textsc{15} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_15.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{15}.
