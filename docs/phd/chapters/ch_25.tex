...
\section{\texorpdfstring{2. \(\varphi\)-Lattice Structure and the Cycle Map}{2. \textbackslash varphi-Lattice Structure and the Cycle Map}}\label{varphi-lattice-structure-and-the-cycle-map}
...
\section{3. Cycle Classification and Attention Periodicity}\label{cycle-classification-and-attention-periodicity}
