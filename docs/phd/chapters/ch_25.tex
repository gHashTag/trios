...
\section*{$\varphi$-Period Cycles}
\addcontentsline{toc}{section}{$\varphi$-Period Cycles}
...
\subsection{\texorpdfstring{2. \(\varphi\)-Lattice Structure and the Cycle Map}{2. \textbackslash varphi-Lattice Structure and the Cycle Map}}\label{varphi-lattice-structure-and-the-cycle-map}
...
\subsection{3. Cycle Classification and Attention Periodicity}\label{cycle-classification-and-attention-periodicity}
...
{[}6{]} \texttt{gHashTag/trios\#419} --- Ch.25 scope definition. https://github.com/gHashTag/trios/issues/419
