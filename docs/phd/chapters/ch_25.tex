...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_25.png}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_25.png}}
\caption{Architectural-blueprint triptych: phase, period, and $\varphi$-return map (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
