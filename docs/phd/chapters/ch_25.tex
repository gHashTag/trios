...
% Original file moved to docs/phd/quarantine/ch\_25.tex (LaTeX parse error).
...
\section*{Deferred chapter: 25}
\addcontentsline{toc}{section}{Deferred chapter: 25}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_25.tex}\par\smallskip
...
The repository draft of \textsc{25} contained a LaTeX parse error
...
Chapter \textsc{25} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_25.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{25}.
