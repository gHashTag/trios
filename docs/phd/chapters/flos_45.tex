...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.18\linewidth,keepaspectratio]{10-golden-bloom.jpg}}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{W8-45-preregister-seeds-three.png}
  \caption{THE PREREG / THE SEEDS / THE EMBARGO. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave8-W8-45-preregister-seeds-three}
\end{figure}
