...
% Original file moved to docs/phd/quarantine/27-trinity-identity.tex (LaTeX parse error).
...
\section*{Deferred chapter: Trinity Identity}
\addcontentsline{toc}{section}{Deferred chapter: Trinity Identity}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/27-trinity-identity.tex}\par\smallskip
...
The repository draft of \textsc{Trinity Identity} contained a LaTeX parse error
...
Chapter \textsc{Trinity Identity} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/27-trinity-identity.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Trinity Identity}.
