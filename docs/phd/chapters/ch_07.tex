...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_07.png}}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_07.png}}
\caption{Architectural-blueprint triptych: Vogel seed, $137.5°$ spiral, and full bloom (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
