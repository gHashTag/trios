...
% Original file moved to docs/phd/quarantine/ch\_07.tex (LaTeX parse error).
...
\section*{Deferred chapter: 07}
\addcontentsline{toc}{section}{Deferred chapter: 07}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_07.tex}\par\smallskip
...
The repository draft of \textsc{07} contained a LaTeX parse error
...
Chapter \textsc{07} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_07.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{07}.
