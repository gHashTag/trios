...
% Original file moved to docs/phd/quarantine/30-golden-imagery.tex (LaTeX parse error).
...
\section*{Deferred chapter: Golden Imagery}
\addcontentsline{toc}{section}{Deferred chapter: Golden Imagery}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/30-golden-imagery.tex}\par\smallskip
...
The repository draft of \textsc{Golden Imagery} contained a LaTeX parse error
...
Chapter \textsc{Golden Imagery} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/30-golden-imagery.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Golden Imagery}.
