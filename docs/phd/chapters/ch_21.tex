...
% Original file moved to docs/phd/quarantine/ch\_21.tex (LaTeX parse error).
...
\section*{Deferred chapter: 21}
\addcontentsline{toc}{section}{Deferred chapter: 21}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_21.tex}\par\smallskip
...
The repository draft of \textsc{21} contained a LaTeX parse error
...
Chapter \textsc{21} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_21.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{21}.
