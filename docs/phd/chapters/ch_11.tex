...
% Original file moved to docs/phd/quarantine/ch\_11.tex (LaTeX parse error).
...
\section*{Deferred chapter: 11}
\addcontentsline{toc}{section}{Deferred chapter: 11}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_11.tex}\par\smallskip
...
The repository draft of \textsc{11} contained a LaTeX parse error
...
Chapter \textsc{11} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_11.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{11}.
