...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-ch_11.jpg}}
\caption{Azbuka triptych: Pre-registration H\textsubscript{1} (3 distinct seeds) (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_11.jpg}}
\caption{Architectural-blueprint triptych: $H_1$ hypothesis, protocol, and pre-registration gate (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
...
\section{2. Hypothesis Formalisation and Registration Protocol}\label{hypothesis-formalisation-and-registration-protocol}
...
\section{3. INV-7 Invariant and Coq Formalisation}\label{inv-7-invariant-and-coq-formalisation}
