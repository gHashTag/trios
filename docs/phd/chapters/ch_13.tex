...
% Original file moved to docs/phd/quarantine/ch\_13.tex (LaTeX parse error).
...
\section*{Deferred chapter: 13}
\addcontentsline{toc}{section}{Deferred chapter: 13}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_13.tex}\par\smallskip
...
The repository draft of \textsc{13} contained a LaTeX parse error
...
Chapter \textsc{13} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_13.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{13}.
