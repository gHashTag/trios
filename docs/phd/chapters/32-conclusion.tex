...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.18\linewidth,keepaspectratio]{32-conclusion.png}}
\end{figure}
...
victory_implies_distinct_clean lives in victory.v as the L7 INV-7 theorem.
