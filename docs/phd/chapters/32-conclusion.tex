...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-32-conclusion.png}}
\caption{Azbuka of the Tridevyatoe — the closing scroll: the quill / the scroll / the seal (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch34-energy-3000x-darpa.png}}
\caption{Energy 3000\(\times\) DARPA (legacy)}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-32-conclusion-a.png}}
\caption{Architectural-blueprint triptych: the summary / the contribution / the thesis (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
