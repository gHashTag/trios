...
% Original file moved to docs/phd/quarantine/ch\_26.tex (LaTeX parse error).
...
\section*{Deferred chapter: 26}
\addcontentsline{toc}{section}{Deferred chapter: 26}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_26.tex}\par\smallskip
...
The repository draft of \textsc{26} contained a LaTeX parse error
...
Chapter \textsc{26} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_26.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{26}.
