...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v511/v511-ch_28.jpg}}
\caption{Architectural-blueprint triptych: XC7A100T substrate, CLB lattice, and bitstream (Trinity S\textsuperscript{3}AI v5.11).}
\end{figure}
