...
\caption{Azbuka triptych: QMTech XC7A100T FPGA (Trinity S\textsuperscript{3}AI v5.16, da Vinci codex).}
\end{figure}
...
\section{2. Architecture: Zero-DSP Ternary Datapath}\label{architecture-zero-dsp-ternary-datapath}
...
\section{3. Resource Utilisation and Timing Closure}\label{resource-utilisation-and-timing-closure}
...
\caption{Azbuka of the Tridevyatoe — Standard Model — Fundamental Particles (figure b) (Trinity S\textsuperscript{3}AI v5.20, da Vinci codex).}
\end{figure}
...
\tightlist
\item
  \textbf{B001} (doi) --- DOI: 10.5281/zenodo.19227865 --- Status: golden --- Links Ch.28, App.H. Notes: HSLM Ternary NN. φ-weight: 1.0.
\item
  \textbf{B002} (doi) --- DOI: 10.5281/zenodo.19227867 --- Status: golden --- Links Ch.28, App.F, App.H. Notes: FPGA Zero-DSP Architecture. φ-weight: 1.0.
\item
