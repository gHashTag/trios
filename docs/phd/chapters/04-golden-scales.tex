...
% Original file moved to docs/phd/quarantine/04-golden-scales.tex (LaTeX parse error).
...
\section*{Deferred chapter: Golden Scales}
\addcontentsline{toc}{section}{Deferred chapter: Golden Scales}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/04-golden-scales.tex}\par\smallskip
...
The repository draft of \textsc{Golden Scales} contained a LaTeX parse error
...
Chapter \textsc{Golden Scales} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/04-golden-scales.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Golden Scales}.
