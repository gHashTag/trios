...
\caption{Golden mantissa: floating-point family}
\end{figure}
...
\caption{Golden Seal — the cryptographic emblem of the chapter, shown in three projections: the ring, the seal, and the witness-tape.}
\end{figure}
