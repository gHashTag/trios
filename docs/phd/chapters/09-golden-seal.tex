...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth,keepaspectratio]{ch09-gf-vs-mxfp4-ablation.png}
...
\texttt{igla/INV3\_Gf16Precision.v}. GF16
...
\subsection{2. GF16 PHI\_BIAS=60 and the INV-3
Safe
Domain}\label{gf16-phi_bias60-and-the-inv-3-safe-domain}

\subsubsection{2.1 GF16 Format
...
\subsubsection{2.2 INV-3: Nine Coq Precision
...
\subsubsection{2.3 Competitor Format
...
\subsection{3. Ablation Matrix: Tier-A/B/C $\times$
...
\texttt{t27/proofs/canonical/} are directly
anchored to this chapter; the relevant Qed
obligations are the nine bounds of INV-3
(\texttt{igla/INV3\_Gf16Precision.v}) and the
spectral constant in \texttt{sacred/AlphaPhi.v},
...
\item
  ...
  \texttt{https://github.com/gHashTag/t27/blob/feat/canonical-coq-home/proofs/canonical/igla/INV3\_Gf16Precision.v}
...
[2] gHashTag/t27,
\texttt{proofs/canonical/sacred/AlphaPhi.v}.
GitHub.
https://github.com/gHashTag/t27/blob/feat/canonical-coq-home/proofs/canonical/sacred/AlphaPhi.v

[3] gHashTag/t27,
\texttt{proofs/canonical/igla/INV3\_Gf16Precision.v}.
GitHub.
https://github.com/gHashTag/t27/blob/feat/canonical-coq-home/proofs/canonical/igla/INV3\_Gf16Precision.v
...
GitHub. https://github.com/gHashTag/trios
...
Ch.15 --- BPB Benchmark and Neon Write-Back.

[13] Zenodo DOI bundle B001--B013.
https://doi.org/10.5281/zenodo.19227867
