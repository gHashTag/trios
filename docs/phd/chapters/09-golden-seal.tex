...
% Original file moved to docs/phd/quarantine/09-golden-seal.tex (LaTeX parse error).
...
\section*{Deferred chapter: Golden Seal}
\addcontentsline{toc}{section}{Deferred chapter: Golden Seal}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/09-golden-seal.tex}\par\smallskip
...
The repository draft of \textsc{Golden Seal} contained a LaTeX parse error
...
Chapter \textsc{Golden Seal} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/09-golden-seal.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Golden Seal}.
