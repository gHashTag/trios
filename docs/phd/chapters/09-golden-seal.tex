...
\caption{Azbuka of the Tridevyatoe — the golden seal: the wax / the stamp / the imprint (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{ch09-gf-vs-mxfp4-ablation.png}}
\caption{GF vs MXFP4 ablation (legacy)}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs-09-seal.png}}
\caption{Engraved triptych for Chapter~9 — \textit{The Mark, The Seal, The Witness} — the golden seal as anchor of formal certification.}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs2-09-seal.png}}
\caption{Engraved triptych companion to the Chapter~9 abstract — \textit{The Wax, The Press, The Impression} — the golden seal as ritual of formal certification.}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-09-golden-seal-a.jpg}}
\caption{Architectural-blueprint triptych: the ablation / the seal / the evidence (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
