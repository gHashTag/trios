...
\caption{Triptych illustrating the chapter 'Sacred Ratios: 360-lane Phi-Distance Grid' (Trinity S\textsuperscript{3}AI v5.21.2, da Vinci x Azbuka).}
\end{figure}
...
\caption{Coin Mint - Trinity S\textsuperscript{3}AI codex plate (da Vinci x Azbuka v5.21.2).}
\end{figure}
