...
\texttt{t27/proofs/canonical/igla/INV4\_NcaEntropyBand.v}
and on the canonical NCA merge tracked in
\texttt{t27\#569} [3].

\subsection{2. The Phi-Distance
...
\subsection{3. Grid Construction and Sparsity
...
[12] \texttt{gHashTag/trios\#408} --- Ch.16
