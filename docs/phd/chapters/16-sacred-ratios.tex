...
% Original file moved to docs/phd/quarantine/16-sacred-ratios.tex (LaTeX parse error).
...
\section*{Deferred chapter: Sacred Ratios}
\addcontentsline{toc}{section}{Deferred chapter: Sacred Ratios}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/16-sacred-ratios.tex}\par\smallskip
...
The repository draft of \textsc{Sacred Ratios} contained a LaTeX parse error
...
Chapter \textsc{Sacred Ratios} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/16-sacred-ratios.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Sacred Ratios}.
