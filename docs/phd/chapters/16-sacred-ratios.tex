...
\caption{Azbuka of the Tridevyatoe — the sacred ratios: the compass / the square / the proportion (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\caption{Standard-Model parameter triptych — the sacred-ratios chapter's motivating phenomenology.}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs2-16-ratios.png}}
\caption{Engraved triptych companion to the Chapter~16 abstract — \textit{The Number, The Proportion, The Law} — Standard-Model coupling constants in golden-ratio form.}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-16-sacred-ratios-a.jpg}}
\caption{Architectural-blueprint triptych: the phi / the pi / the e (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
