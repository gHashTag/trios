...
\begin{tcolorbox}[colback=blue!3,colframe=blue!40!black,title={\textbf{Trinity S\textsuperscript{3}AI Strand} \textbf{Ch.3}}]
...
\section{Abstract}\label{ch_03:abstract}
...
\section{1. Introduction}\label{ch_03:introduction}
...
\section{2. Derivation of the Anchor Identity}\label{ch_03:derivation-of-the-anchor-identity}

\subsection{2.1 Minimal Polynomial and Basic Consequences}\label{ch_03:minimal-polynomial-and-basic-consequences}
...
\subsection{2.2 Power Survey}\label{ch_03:power-survey}
...
\subsection{2.3 Relation to Fibonacci Arithmetic}\label{ch_03:relation-to-fibonacci-arithmetic}
...
\section{3. Coq Mechanisation and SAC-0 Invariant}\label{ch_03:coq-mechanisation-and-sac-0-invariant}

\subsection{3.1 Proof Architecture}\label{ch_03:proof-architecture}
...
\subsection{3.2 Invariant SAC-0}\label{ch_03:invariant-sac-0}
...
\subsection{3.3 The Integer-3 Coincidence}\label{ch_03:the-integer-3-coincidence}
...
\section{4. Results / Evidence}\label{ch_03:results-evidence}
...
\section{5. Qed Assertions}\label{ch_03:qed-assertions}
...
\section{6. Sealed Seeds}\label{ch_03:sealed-seeds}
...
\section{7. Discussion}\label{ch_03:discussion}
...
\section{References}\label{ch_03:references}
...
\section{S1. The Trinity Identity in Detail}\label{ch_03:ch3-s1-trinity-detail}
...
\section{S2. The Family of Phi-Power Identities}\label{ch_03:ch3-s2-phi-family}
...
\section{S4. Numeric Window for the Anchor}\label{ch_03:ch3-s4-numeric}
...
\section{S5. The Trinity Identity in the Architecture}\label{ch_03:ch3-s5-arch}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{W8-37-trinity-identity-deep.png}
  \caption{THE IDENTITY / THE DEEP / THE PROOF. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave8-W8-37-trinity-identity-deep}
\end{figure}
