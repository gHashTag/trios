...
% Original file moved to docs/phd/quarantine/ch\_24.tex (LaTeX parse error).
...
\section*{Deferred chapter: 24}
\addcontentsline{toc}{section}{Deferred chapter: 24}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_24.tex}\par\smallskip
...
The repository draft of \textsc{24} contained a LaTeX parse error
...
Chapter \textsc{24} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_24.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{24}.
