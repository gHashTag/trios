...
% Original file moved to docs/phd/quarantine/12-flower-of-life.tex (LaTeX parse error).
...
\section*{Deferred chapter: Flower Of Life}
\addcontentsline{toc}{section}{Deferred chapter: Flower Of Life}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/12-flower-of-life.tex}\par\smallskip
...
The repository draft of \textsc{Flower Of Life} contained a LaTeX parse error
...
Chapter \textsc{Flower Of Life} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/12-flower-of-life.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Flower Of Life}.
