...
\begin{tcolorbox}[colback=yellow!4,colframe=yellow!50!brown,title={\textbf{Flos Aureus} \textbf{FA.18 Torus Geometry}}]
  \textbf{Petal:} Part V --- \emph{Sacred Geometry} \\
  \textbf{Anchor:} \(\varphi^{2} + \varphi^{-2} = 3\) (Trinity Identity, INV-22) \\
  \textbf{Motif:} the donut of resonance \\
  \textbf{Lane:} L18 (Flos Aureus strand) \\
...
\section{Abstract}\label{fa_18:abstract}
...
\section{1. Introduction}\label{fa_18:introduction}
...
(CLARA-SOA
Snapshot)}\label{fa_18:state-of-the-art-comparison-clara-soa-snapshot}
...
Lane}\label{fa_18:coq.interval-upgrade-lane}
...
Limitations}\label{fa_18:hardware-and-runtime-limitations}
...
\section{References}\label{fa_18:references}
...
\label{fa_18:sec:falsification:ch18}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{W8-18-torus-falsification-limit.png}
  \caption{THE TORUS / THE FALSIFY / THE LIMIT. Anchor: $\varphi^2+\varphi^{-2}=3$. [AI-generated illustration, style anchor: title-page triptych]}
  \label{fig:wave8-W8-18-torus-falsification-limit}
\end{figure}
