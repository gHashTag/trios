...
% Original file moved to docs/phd/quarantine/ch\_08.tex (LaTeX parse error).
...
\section*{Deferred chapter: 08}
\addcontentsline{toc}{section}{Deferred chapter: 08}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/ch\_08.tex}\par\smallskip
...
The repository draft of \textsc{08} contained a LaTeX parse error
...
Chapter \textsc{08} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/ch\_08.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{08}.
