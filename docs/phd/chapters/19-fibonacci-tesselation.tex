...
% Original file moved to docs/phd/quarantine/19-fibonacci-tesselation.tex (LaTeX parse error).
...
\section*{Deferred chapter: Fibonacci Tesselation}
\addcontentsline{toc}{section}{Deferred chapter: Fibonacci Tesselation}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/19-fibonacci-tesselation.tex}\par\smallskip
...
The repository draft of \textsc{Fibonacci Tesselation} contained a LaTeX parse error
...
Chapter \textsc{Fibonacci Tesselation} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/19-fibonacci-tesselation.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{Fibonacci Tesselation}.
