...
% Original file moved to docs/phd/quarantine/22-e8-symmetry.tex (LaTeX parse error).
...
\section*{Deferred chapter: E8 Symmetry}
\addcontentsline{toc}{section}{Deferred chapter: E8 Symmetry}
...
\textit{Quarantined draft}: \texttt{docs/phd/quarantine/22-e8-symmetry.tex}\par\smallskip
...
The repository draft of \textsc{E8 Symmetry} contained a LaTeX parse error
...
Chapter \textsc{E8 Symmetry} is one of 33 lanes in the Flos Aureus thesis
...
\texttt{docs/phd/chapters/22-e8-symmetry.tex} will be regenerated automatically
...
audit-of-record for the chapter \textsc{E8 Symmetry}.
