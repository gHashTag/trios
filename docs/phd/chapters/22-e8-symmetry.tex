...
\subsection{2. Worker Pool Invariants and
Falsification
...
Predicate
\texttt{inv12\_holds\ r\_thr\ =\ (r\_thr\ ≤\ max\_throughput)}
...
\subsection{3. Satisfaction Witness and Victory
...
\emph{Coq theorem
\texttt{valid\_config\_satisfies\_composite}.}
...
\item
  ...
  (\texttt{gHashTag/t27/proofs/canonical/igla/INV8\_WorkerPoolComposite.v})
  --- \emph{Status: Qed} ---
  \texttt{inv2\_holds\ (265\ \#\ 100)\ =\ false}:
...
[3] \texttt{gHashTag/trios\#408} --- Ch.22
