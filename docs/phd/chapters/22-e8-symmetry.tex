...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v516/v516-22-e8-symmetry.png}}
\caption{Azbuka of the Tridevyatoe — the E8 lattice: the root / the lattice / the projection (Trinity S\textsuperscript{3}AI v5.14, da Vinci codex).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs-22-e8.png}}
\caption{Engraved triptych for Chapter~22 — \textit{The Lattice, The Root, The Group} — $E_{8}$ symmetry and its golden-ratio coordinates.}
\end{figure}

\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{abs2-22-e8.png}}
\caption{Engraved triptych companion to the Chapter~22 abstract — \textit{The Root, The Lattice, The Group} — 240 root vectors of $E_{8}$ in concentric phi-spaced circles.}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-22-e8-a.png}}
\caption{E8 symmetry projections: the lattice / the root / the coxeter (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
...
\begin{figure}[H]
\centering
\makebox[\linewidth][c]{\includegraphics[width=1.05\linewidth,keepaspectratio]{assets/illustrations/v513/v513-22-e8-b.png}}
\caption{E8 symmetry projections: the 240 / the 8 / the group (Trinity S\textsuperscript{3}AI v5.13).}
\end{figure}
