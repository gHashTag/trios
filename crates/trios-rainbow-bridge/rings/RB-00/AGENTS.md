# Agent Instructions — RB-00

## Context

This is the `json-schema` ring of `trios-rainbow-bridge`, scaffolded for issue #238.
...
- Add types and functions that belong to the `json-schema` concern
