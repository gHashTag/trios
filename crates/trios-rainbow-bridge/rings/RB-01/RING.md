# RING — RB-01 (trios-rainbow-bridge)
...
|-------|-------|
| Metal | 🥉 Bronze |
| Package | trios-rainbow-bridge-rb01 |
| Sealed | No |

## Purpose

`rust-runtime` ring for `trios-rainbow-bridge`. Scaffolded as part of issue #238 to bring
this crate under the ring-isolation architecture (L-ARCH-001).

## Ring scope

This ring will eventually own the `rust-runtime` concern of `trios-rainbow-bridge`.
