# Agent Instructions — RB-01

## Context

This is the `rust-runtime` ring of `trios-rainbow-bridge`, scaffolded for issue #238.
...
- Add types and functions that belong to the `rust-runtime` concern
