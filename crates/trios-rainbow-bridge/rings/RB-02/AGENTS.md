# Agent Instructions — RB-02

## Context

This is the `coq-bridge` ring of `trios-rainbow-bridge`, scaffolded for issue #238.
...
- Add types and functions that belong to the `coq-bridge` concern
