# RING — BR-OUTPUT (trios-operator-smoke)
...
|-------|-------|
| Metal | 🥉 Bronze |
| Package | trios-operator-smoke-broutput |
| Sealed | No |

## Purpose

`output` ring for `trios-operator-smoke`. Scaffolded as part of issue #238 to bring
this crate under the ring-isolation architecture (L-ARCH-001).

## Ring scope

This ring will eventually own the `output` concern of `trios-operator-smoke`.
