# RING — OS-01 (trios-operator-smoke)
...
|-------|-------|
| Metal | 🥉 Bronze |
| Package | trios-operator-smoke-os01 |
| Sealed | No |

## Purpose

`report` ring for `trios-operator-smoke`. Scaffolded as part of issue #238 to bring
this crate under the ring-isolation architecture (L-ARCH-001).

## Ring scope

This ring will eventually own the `report` concern of `trios-operator-smoke`.
