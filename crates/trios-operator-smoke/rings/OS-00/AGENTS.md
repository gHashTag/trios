# Agent Instructions — OS-00

## Context

This is the `smoke` ring of `trios-operator-smoke`, scaffolded for issue #238.
...
- Add types and functions that belong to the `smoke` concern
