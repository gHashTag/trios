# RING — OS-00 (trios-operator-smoke)
...
|-------|-------|
| Metal | 🥉 Bronze |
| Package | trios-operator-smoke-os00 |
| Sealed | No |

## Purpose

`smoke` ring for `trios-operator-smoke`. Scaffolded as part of issue #238 to bring
this crate under the ring-isolation architecture (L-ARCH-001).

## Ring scope

This ring will eventually own the `smoke` concern of `trios-operator-smoke`.
