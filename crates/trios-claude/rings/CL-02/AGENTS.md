...
- Ring: CL-02
- Package: trios-claude-cl02
- Role: dispatch (scaffold — logic migration: TODO)

## What this ring does (target)

Owns dispatch logic for trios-claude after migration.
...
```bash
cargo check -p trios-claude-cl02
cargo test  -p trios-claude-cl02
```
