# AGENTS.md — BR-OUTPUT (trios-claude)
...
- Ring: BR-OUTPUT
- Package: trios-claude-broutput
- Role: assembly (scaffold — logic migration: TODO)

## What this ring does (target)

Owns assembly logic for trios-claude after migration.
...
```bash
cargo check -p trios-claude-broutput
cargo test  -p trios-claude-broutput
```
