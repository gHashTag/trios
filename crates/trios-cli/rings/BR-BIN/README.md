# Ring BR-BIN — binary bridge

> Часть крейта `trios-cli` · Scaffolded for issue #380 · Invariant I5

## Назначение / Purpose

Ring scaffold for the `trios-cli` ring graph (binary bridge). Placeholder ring satisfying
...
- Parent crate: [`trios-cli`](../../README.md)
