...
|-------|-------|
| Metal | 🥉 Bronze |
| Package | trios-cli-brbin |
| Sealed | No |

## Purpose

`binary` ring for `trios-cli`. Scaffolded as part of issue #238 to bring
this crate under the ring-isolation architecture (L-ARCH-001).

## Ring scope

This ring will eventually own the `binary` concern of `trios-cli`.
