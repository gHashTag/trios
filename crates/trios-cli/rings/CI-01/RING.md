...
|-------|-------|
| Metal | 🥉 Bronze |
| Package | trios-cli-ci01 |
| Sealed | No |

## Purpose

`repl` ring for `trios-cli`. Scaffolded as part of issue #238 to bring
this crate under the ring-isolation architecture (L-ARCH-001).

## Ring scope

This ring will eventually own the `repl` concern of `trios-cli`.
