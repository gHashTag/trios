# AGENTS.md — SILVER-RING-EXT-03

> AAIF-compliant (Linux Foundation Agentic AI Foundation)
> MCP-compatible agent instructions

## Identity
- Ring: SILVER-RING-EXT-03
- Metal: Silver
- Crate: trios-ext
- Package: trios-ext-ring-ex03

## What this ring does
Comet bridge and typed message envelopes for trios-server ↔ Chrome extension WebSocket communication.
...
## You MAY
- ✅ Edit src/lib.rs, src/comet.rs, src/types.rs within this ring
...
- Build: `cargo build -p trios-ext-ring-ex03`
- Test: `cargo test -p trios-ext-ring-ex03`
